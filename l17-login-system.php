...
if (isset($_POST['login'])) {
    ...
    if ($uname == "hayder" && $pass == "123456") {
        ...
        $_SESSION['user'] = "Hayder ALi";
    } else {
        $msg = "<div class='alert alert-danger alert-dismissible mt-3'>Username or password problem<button class='btn-close' data-bs-dismiss='alert'></button></div>";
    }
}
