<?php 
    if (isset($_POST['login'])) {
       $uname=$_POST['uname'];
       $pass=$_POST['pass'];
       if ($uname=="ahasanur"&& $pass==1997722799) {
        $msg= "<div class='alert alert-success alert-dismissible'>Login Successful<button class='btn-close' data-bs-dismiss='alert'></div>";
        $_SESSION['user']='Welcome To Ahasans Log in page';
       }else {
        $msg= "<div class='alert alert-danger alert-dismissible'>Invalid Log in Information<button class='btn-close' data-bs-dismiss='alert'></div>";
       }
    }
