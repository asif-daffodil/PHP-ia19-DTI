...
echo "<body style='background-color:orange'>";
    if (isset($_POST['login'])) {
       $uname=$_POST['uname'];
       $pass=$_POST['pass'];
       if ($uname=="afraim"&& $pass==123456) {
        $msg= "<div class='alert alert-success alert-dismissible'>LogIn Successfully<button class='btn-close' data-bs-dismiss='alert'></div>";
        $_SESSION['user']='Welcome To Log in My Website';
       }else {
        $msg= "<div class='alert alert-danger alert-dismissible'>Invalid Log In <button class='btn-close' data-bs-dismiss='alert'></div>";
       }
    }
