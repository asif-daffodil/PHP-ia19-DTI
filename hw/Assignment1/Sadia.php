<?php 
    if (isset($_POST['login'])) {
       $uname=$_POST['uname'];
       $pass=$_POST['pass'];
       if ($uname=="sadia"&& $pass==123456) {
        $msg= "<div class='alert alert-success alert-dismissible'>Login Successfully<button class='btn-close' data-bs-dismiss='alert'></div>";
        $_SESSION['user']='Welcome To Log in page';
       }else {
