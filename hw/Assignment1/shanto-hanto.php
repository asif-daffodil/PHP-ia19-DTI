<?php 
    if (isset($_POST['login'])) {
       $uname=$_POST['uname'];
       $pass=$_POST['pass'];
       if ($uname=="shanto"&& $pass==152001) {
        $msg= "<div class='alert alert-success alert-dismissible'>Hurrey! Login sucessfull class='btn-close' data-bs-dismiss='alert'></div>";
        $_SESSION['user']='Welcome To Anowar Hossain Shanto';
       }else {
        $msg= "<div class='alert alert-danger alert-dismissible'>Try again Another time <button class='btn-close' data-bs-dismiss='alert'></div>";
       }
    }
